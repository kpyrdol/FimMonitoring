...
namespace FIMMonitoring.Service
{
    public partial class FIMMonitoringService : ServiceBase
    {
        ...
        {
            Logger.Log.Info("Importer errors service has been started at " + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
        ...
        {
            Logger.Log.InfoFormat("Importer errors service was shutdown at {0}", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"));
        }
